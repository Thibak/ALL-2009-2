...
filename tranfile "&disk.:\AC\OLL-2009\lib_arch\R_&sysdate9..stc"; * условный идентификатор транспортного файла;
...
/*Для использования разделителя запятой применяется следующие форматы, для соответствующих переменных*/
/*http://support.sas.com/documentation/cdl/en/lrdict/64316/HTML/default/viewer.htm#a000200612.htm*/
/*format COMMAXw.d*/
/*Вопрос в том, как это оптимизировать.*/
